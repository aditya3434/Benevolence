...
%>
  ...
  <center>
  <p>
  Username : <%=resultSet2.getString("username") %><br><br>
  First name : <%=resultSet2.getString("FirstName") %><br><br>
  Last name : <%=resultSet2.getString("LastName") %><br><br>
  Phone no. : <%=resultSet2.getString("phone") %><br><br>
  E-mail ID : <%=resultSet2.getString("emailid") %><br><br>
  <br>
  ...
  <input type="submit" value="Ban User" style="background-color: rgb(220,0,0);
	...
	color: #fff;
	transition: 0.4s;">
  <input type="hidden" name="uname" value=<%=resultSet2.getString("username")%>>
  </form>
  </p>
  </center>
  </div>
